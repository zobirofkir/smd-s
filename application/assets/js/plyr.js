"object" == typeof navigator && function(e, t) {
    ...
    var I, L, O, _ = function() {
        function e(t, i) {
            ...
            E(this.element) && M(this.element.rangeTouch) && (this.config = p({}, f, {}, i),
            this.init())
        }
        return function(e, t, i) {
            ...
            key: "set",
            value: function(t) {
                e.enabled && N(t) && !t.target.disabled && (t.preventDefault(),
            ...
            value: function(t) {
                var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
                  , n = null;
                if (M(t) || A(t) ? n = Array.from(document.querySelectorAll(A(t) ? t : 'input[type="range"]')) : E(t) ? n = [t] : P(t) ? n = Array.from(t) : S(t) && (n = t.filter(E)),
                M(n))
                    return null;
                var a = p({}, f, {}, i);
                if (A(t) && a.watch) {
    ...
    var Ve = {
        ...
        cancelRequests: function() {
            this.isHTML5 && (pe(Ve.getSources.call(this)),
    ...
    function Ge(e, t) {
        if (Y(e)) {
            var i = "cache"
              ...
              , s = function(e, t) {
                e.innerHTML = t,
                n && a() || document.body.insertAdjacentElement("afterbegin", e)
            };
            if (!n || !a()) {
                var r = $e.supported
    ...
    var nt = {
        ...
        setQualityMenu: function(e) {
            ...
            if (G(this.elements.settings.panels.quality)) {
                ...
                console.log("count=>"+this.options.quality.length);
                if (nt.toggleMenuButton.call(this, i, a),
                fe(n),
        ...
        setCaptionsMenu: function() {
            ...
            if (G(this.elements.settings.panels.captions)) {
                var t = "captions"
                  ...
                  , a = Boolean(n.length);
                if (nt.toggleMenuButton.call(this, t, a),
                fe(i),
                nt.checkMenu.call(this),
                a) {
                    ...
                    s.forEach(nt.createMenuItem.bind(this)),
        ...
        setSpeedMenu: function() {
            ...
            if (G(this.elements.settings.panels.speed)) {
                ...
                nt.toggleMenuButton.call(this, t, n),
                fe(i),
                nt.checkMenu.call(this),
        ...
        create: function(e) {
            ...
            return Be($(this.config.controls) ? this.config.controls : []).forEach((function(o) {
                ...
                "mute" === o || "volume" === o) {
                    ...
                    t.elements.volume = p,
                    u.appendChild(p)),
                    "mute" === o && p.appendChild(n.call(t, "mute")),
                    "volume" === o && !oe.isIos) {
                        var f = {
                            max: 1,
                            step: .05,
        ...
        inject: function() {
            ...
            a = !1);
            var s, r;
            if (a && Y(this.config.controls) && (s = i,
            ...
            i = s),
            Y(this.config.selectors.controls.container) && (r = document.querySelector(this.config.selectors.controls.container)),
            G(r) || (r = this.elements.container),
            r[G(i) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", i),
      ...
      , vt = function() {
        ...
        return i(t, [{
            ...
            value: function() {
                ...
                this.bind(i.buttons.rewind, "click", (function() {
                    t.lastSeekTime = Date.now(),
                    t.rewind()
                }
                ), "rewind"),
                this.bind(i.buttons.fastForward, "click", (function() {
                    t.lastSeekTime = Date.now(),
                    t.forward()
                }
                ), "fastForward"),
                ...
                this.bind(i.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (function(e) {
                    ...
                    if (!ee(e) || 39 === n || 37 === n) {
                        ...
                        s && r ? (i.removeAttribute(a),
                        De(t.play())) : !r && t.playing && (i.setAttribute(a, ""),
                        t.pause())
                    }
                }
                )),
    ...
    var bt = function(e, t) {
        ...
        e.exports = function() {
            ...
            function o(t, i, n, a) {
                var s, r, l = document, c = n.async, u = (n.numRetries || 0) + 1, d = n.before || e, h = t.replace(/[\?|#].*$/, ""), m = t.replace(/^(css|img)!/, "");
                a = a || 0,
                /(^css!|\.css$)/.test(h) ? ((r = l.createElement("link")).rel = "stylesheet",
                r.href = m,
                (s = "hideFocus"in r) && r.relList && (s = 0,
                r.rel = "preload",
                r.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(h) ? (r = l.createElement("img")).src = m : ((r = l.createElement("script")).src = t,
                r.async = void 0 === c || c),
            ...
            function l(e, t, i) {
                var n, a, s = (e = e.push ? e : [e]).length, r = s, l = [];
    ...
    var Tt = {
        ...
        ready: function() {
            ...
            var d, h = ae(d = u) ? null : K(Number(d)) ? d : d.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : d, m = he("iframe"), p = Ue(t.config.urls.vimeo.iframe, h, c);
            if (m.setAttribute("src",p),
            m.setAttribute("allowfullscreen", ""),
            m.setAttribute("allow", "autoplay,fullscreen,picture-in-picture"),
            ae(a) || m.setAttribute("referrerPolicy", a),
            n || !i.customControls)
                m.setAttribute("data-poster", t.poster),
                t.media = ge(m, t.media);
            else {
                var f = he("div", {
    ...
    var St = {
        ...
        ready: function() {
            ...
            if (ae(i) || !i.startsWith("youtube-")) {
                ...
                var a, s, r = ae(a = n) ? null : a.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : a, o = he("div", {
                    id: (s = e.provider,
                    "".concat(s, "-").concat(Math.floor(1e4 * Math.random()))),
                    "data-poster": t.customControls ? e.poster : void 0
                });
                if (e.media = ge(o, e.media),
                t.customControls) {
                    var l = function(e) {
                    ...
                    events: {
                        ...
                        onStateChange: function(i) {
                            ...
                            case 0:
                                ...
                                n.playVideo()) : Oe.call(e, e.media, "ended");
                                break;
                            case 1:
                                t.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (Ct.call(e, !0),
      ...
      , xt = {
        ...
        change: function(e) {
            ...
            this.destroy.call(this, (function() {
                ...
                t.config.autoplay && t.media.setAttribute("autoplay", "1"),
                ae(e.poster) || (t.poster = e.poster),
                t.config.loop.active && t.media.setAttribute("loop", "1"),
                t.config.muted && t.media.setAttribute("muted", "1"),
                ...
                t.config.previewThumbnails.enabled && (t.previewThumbnails = new Mt(t))),
                t.fullscreen.update()
            }
    ...
    var It, Lt = function() {
        function t(i, n) {
            ...
            this.debug = new pt(this.config.debug),
            ...
            !W(this.media) && G(this.media))
                if (this.media.plyr)
                    ...
                    if (Ee.check().api) {
                        ...
                        this.isHTML5 && this.config.autoplay && this.once("canplay", (function() {
                            return De(a.play())
                        }
                        )),
                        this.lastSeekTime = 0,
                        this.config.previewThumbnails.enabled && (this.previewThumbnails = new Mt(this))) : this.debug.error("Setup failed: no support")
                    } else
        ...
        return i(t, [{
            ...
            value: function(e) {
                if (this.supported.ui && !this.isAudio) {
                    ...
                    if (n && $(this.config.controls) && this.config.controls.includes("settings") && !ae(this.config.settings) && nt.toggleMenu.call(this, !1),
                    n !== t) {
            ...
            value: function(e) {
                ...
                if (this.ready) {
                    var n = function() {
                        ...
                        t.embed = null,
                        i ? (Object.keys(t.elements).length && (pe(t.elements.buttons.play),
                        pe(t.elements.captions),
                        pe(t.elements.controls),
                        pe(t.elements.wrapper),
                        t.elements.buttons.play = null,
                        t.elements.captions = null,
                        t.elements.controls = null,
                        t.elements.wrapper = null),
                        X(e) && e()) : (_e.call(t),
                        Ve.cancelRequests.call(t),
            ...
            set: function(e) {
                this.isVideo ? Y(e) && qe(e) ? (this.config.ratio = e,
